...
cascadePath = "C:/Users/User/Downloads/face-recognition-assignment-master/face-recognition-assignment-master/haarcascade_frontalface_default.xml"
...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if Id == 1:
            ...
            Id = "sundar {0:.2f}%".format(round(100 - confidence, 2))
            # Put text describe who is in the picture
        elif Id == 3:
            Id = "pradeep {0:.2f}%".format(round(100 - confidence, 2))
        elif Id == 4:
            Id = "meruga {0:.2f}%".format(round(100 - confidence, 2))
